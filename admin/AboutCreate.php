            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="AboutIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-book-reader fa-sm text-white-50"></i>About</a>
                    </div>
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <label for="name">Name<sup class="text-danger">*</sup></label>
                                            <input  type="text" name="name" id="name" class="form-control" placeholder="Name" value="<?php if(isset($_REQUEST['name']))  { echo $__REQUEST['name'];}?>">
                                        </div>
                                        <div class="form-group">
                                        <label for="profile">Profile</label>
                                            <input  type="text" name="profile" id="profile" class="form-control" placeholder="Profile" value="<?php if(isset($_REQUEST['profile']))  { echo $__REQUEST['profile'];}?>">
                                        </div>
                                        <div class="form-group">
                                        <label for="email">Email</label>
                                            <input  type="email" name="email" id="email" class="form-control" placeholder="email" value="<?php if(isset($_REQUEST['email']))  { echo $__REQUEST['email'];}?>">
                                        </div>
                                        <div class="form-group">
                                        <label for="phone">Phone</label>
                                            <input  type="number" name="phone" id="phone" class="form-control" placeholder="phone" value="<?php if(isset($_REQUEST['phone']))  { echo $__REQUEST['phone'];}?>">
                                        </div>
                                        <div class="form-group">

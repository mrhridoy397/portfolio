            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="CounterIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Counter</a>
                    </div>
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin">
                                        ...
                                        <label for="number">Number<sup class="text-danger">*</sup></label>
                                            <input  type="text" name="number" id="number" class="form-control" placeholder="Number" value="<?php if(isset($_REQUEST['number']))  { echo $__REQUEST['number'];}?>">
                                        </div>
                                        <div class="form-group">

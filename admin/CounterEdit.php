...
$data = $counter->editcounter($_REQUEST['id']);
if (isset($_REQUEST['submit']) && count($_REQUEST) > 1) $Response = $counter->Updatecounter($_REQUEST);
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin">
                                        ...
                                        <div class="form-group">
                                        <label for="number">Number<sup class="text-danger">*</sup></label>
                                            <input  type="text" name="number" id="shortTitle" class="form-control" placeholder="Number" value="<?php if(isset($_REQUEST['number']))  { echo $__REQUEST['number'];} else{echo $data['number'];} ?>">
                                        </div>
                                        <div class="form-group">

...
$Response = [];
$active = $Faq->active;
if (isset($_REQUEST) && count($_REQUEST) > 0) $Response = $Faq->Cratequestions($_REQUEST);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="FaqIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">FAQ</a>
                    </div>

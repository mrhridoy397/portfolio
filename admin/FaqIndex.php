...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">All FAQ</h1>
                        <a href="FaqCreate.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> Create FAQ</a>
                    </div>
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="FaqEdit.php?id=<?php echo $data['id']; ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
    ...
    <script>
        $('.delete').on('click',function(){
            var value = $(this).val();
            var url = "FaqDelete.php?id="+value;

...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="HeroariaCreate.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users fa-sm text-white-50"></i> Create <?php echo ucfirst($active); ?></a>
                    </div>
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="HeroariaEdit.php?id=<?php echo $data['id']; ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
    ...
    <script>
        $('.delete').on('click',function(){
            var value = $(this).val();
            var url = "HeroariaDelete.php?id="+value;

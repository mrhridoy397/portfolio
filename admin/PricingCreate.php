...
if (isset($_REQUEST) && count($_REQUEST) > 0) $Response = $Pricing->createpricing($_REQUEST);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="PricingIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Pricing</a>
                    </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin">
                                        ...
                                        <div class="form-group">
                                        <label for="Pricing">Pricing<sup class="text-danger">*</sup></label>
                                            <input  type="text" name="Pricing" id="Pricing" class="form-control" placeholder="Pricing" value="<?php if(isset($_REQUEST['Pricing']))  { echo $__REQUEST['Pricing'];}?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group text-center mt-5">
                                            ...
                                            <a href="PricingIndex.php" class="btn btn-danger ">Cancle</a>
                                        </div>
                                    </form>
                                </div>
                            </div>

...
$data = $Pricing->editpricing($_REQUEST['id']);
if (isset($_REQUEST['submit']) && count($_REQUEST) > 1) $Response = $Pricing->Updatepricing($_REQUEST);
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin">
                                        ...
                                        <label for="Pricing">Pricing<sup class="text-danger">*</sup></label>
                                            <input  type="text" name="Pricing" id="Pricing" class="form-control" placeholder="Pricing" value="<?php if(isset($_REQUEST['Pricing']))  { echo $__REQUEST['Pricing'];} else{echo $data['Pricing'];} ?>">
                                        </div>
                                        <div class="form-group">

 ...
 <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <li class="nav-item">
         ...
         <div id="heroaria" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="HeroIndex.php">HeroAria</a>
             </div>
         </div>
     </li>
         <!-- Divider -->
     ...
     <li class="nav-item">
         ...
         <div id="about" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="AboutIndex.php">About</a>
             </div>
         </div>
     </li>
         <!-- Divider -->
     ...
     <li class="nav-item">
         ...
         <div id="counter" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="CounterIndex.php">Counter</a>
             </div>
         </div>
     </li>
               <!-- Divider -->
   ...
   <!-- Divider -->
    <hr class="sidebar-divider my-0">
     <!-- Nav Item - Pages Collapse Menu -->
     <li class="nav-item">
         <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#Testimonial" aria-expanded="true" aria-controls="collapsePages">
         <i class="fab fa-affiliatetheme"></i>
             <span>Testimonial</span>
         </a>
         <div id="Testimonial" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="testimonialsIndex.php">All Testimonial</a>
             </div>
         </div>
     </li>

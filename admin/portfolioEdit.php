...
$data = $portfolio->edit($_REQUEST['id']);
if (isset($_REQUEST['submit']) && count($_REQUEST) > 1) $Response = $portfolio->Update($_REQUEST, $_FILES);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="portfolioIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> All <?php echo $active; ?></a>
                    </div>
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <label for="Category">Category</label>
                                            <input  type="text" name="Category" id="Category" class="form-control" placeholder="Category" value="<?php if(isset($_REQUEST['Category']))  { echo $__REQUEST['Category'];} else{echo $data['Category'];} ?>">
                                        </div>
                                        <div class="form-group">
                                        <label for="Client">Client</label>
                                            <input  type="text" name="Client" id="Client" class="form-control" placeholder="Client" value="<?php if(isset($_REQUEST['Client']))  { echo $__REQUEST['Client'];} else{echo $data['Client'];} ?>">
                                        </div>
                                        <div class="form-group">
                                        <label for="Projectdate">Project Date</label>
                                            <input  type="text" name="Projectdate" id="Projectdate" class="form-control" placeholder="Project Date" value="<?php if(isset($_REQUEST['Projectdate']))  { echo $__REQUEST['Projectdate'];} else{echo $data['Projectdate'];} ?>">
                                        </div>
                                        <div class="form-group">
                                        <label for="ProjectURL">Project URL</label>
                                            <input  type="text" name="ProjectURL" id="ProjectURL" class="form-control" placeholder="Project URL" value="<?php if(isset($_REQUEST['ProjectURL']))  { echo $__REQUEST['ProjectURL'];} else{echo $data['ProjectURL'];} ?>">
                                        </div>
                                        <div class="form-group">

...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">All Portfolio</h1>
                        <a href="portfolioCreate.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> Create Portfolio</a>
                    </div>
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $data['Projectdate']; ?></td>
                                                <td><?php echo $data['ProjectURL']; ?></td>
                                                <td>
                                                    <?php
                                                    if ($data['status'] == 0) {
                                                        echo "Deactive";
                                                ...
                                                <td>
                                                    <a href="portfolioEdit.php?id=<?php echo $data['id']; ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
    ...
    <script>
        $('.delete').on('click',function(){
            var value = $(this).val();
            var url = "portfolioDelete.php?id="+value;

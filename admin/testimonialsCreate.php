...
if (isset($_REQUEST) && count($_REQUEST) > 0) $Response = $testimonials->createtestimonials($_REQUEST, $_FILES);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="testimonialsIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-book-reader fa-sm text-white-50"></i>Testimonials</a>
                    </div>

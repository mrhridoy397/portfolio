...
$portfolio = $heroaria->detailsportfolio($_REQUEST['id']);
          ...
          <div class="col-lg-3" data-aos="fade-up" data-aos-delay="100">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Project date</strong><?php echo $portfolio['Projectdate']; ?></li>
                <li><strong>Project URL</strong> <a href="<?php echo $portfolio['ProjectURL']; ?>"><?php echo $portfolio['ProjectURL']; ?></a></li>
                <li><a href="<?php echo $portfolio['ProjectURL']; ?>" class="btn-visit align-self-start">Visit Website</a></li>
              </ul>
            </div>
          </div>
